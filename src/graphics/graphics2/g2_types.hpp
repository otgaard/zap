...
using col1u_t = core::colour1<uint32_t>;
...
using vtx_p2c1_t = vertex<pos2f_t, col1u_t>;
...
using vbuf_p2c1_t = vertex_buffer<vtx_p2c1_t>;
...
using mesh_p2c1_t = mesh<vertex_stream<vbuf_p2c1_t>>;
